...
# ---------------------------------------------------------------------------
app = FastAPI(
    title="PRISM (Packaged Rules Inspection & Scanning Mechanism) API",
    description=(
...
def on_startup():
    try:
        ...
        print(f"Database auto-migration warning: {exc}")
...
def root():
    ...
    return {
        "service": "PRISM (Packaged Rules Inspection & Scanning Mechanism) API",
        "version": "1.0.0",
        "description": (
